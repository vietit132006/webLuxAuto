...
use App\Http\Controllers\Admin\AdminCustomerApiController;
use App\Http\Controllers\Admin\AdminPromotionController;
use App\Http\Controllers\Admin\AdminReportApiController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:admin,staff')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('api')->name('api.')->group(function () {
            Route::get('/reports/sales', [AdminReportApiController::class, 'sales'])->name('reports.sales');
            Route::get('/reports/best-sellers', [AdminReportApiController::class, 'bestSellers'])->name('reports.best_sellers');
            Route::get('/reports/inventory', [AdminReportApiController::class, 'inventory'])->name('reports.inventory');
            Route::get('/reports/customers', [AdminReportApiController::class, 'customers'])->name('reports.customers');
            Route::get('/reports/reviews', [AdminReportApiController::class, 'reviews'])->name('reports.reviews');
            Route::get('/reports/customers/top-spenders', [AdminReportApiController::class, 'topSpenders'])->name('reports.customers.top_spenders');
            Route::get('/reports/customers/new-vs-returning', [AdminReportApiController::class, 'newVsReturning'])->name('reports.customers.new_vs_returning');
            Route::get('/reports/reviews/averages', [AdminReportApiController::class, 'reviewAverages'])->name('reports.reviews.averages');
            Route::get('/reports/reviews/most-reviewed', [AdminReportApiController::class, 'mostReviewed'])->name('reports.reviews.most_reviewed');
            Route::get('/reports/reviews/cars/{car}', [AdminReportApiController::class, 'reviewsForCar'])->name('reports.reviews.by_car');

            Route::get('/customers', [AdminCustomerApiController::class, 'index'])->name('customers.index');
            Route::get('/customers/{user}', [AdminCustomerApiController::class, 'show'])->name('customers.show');
