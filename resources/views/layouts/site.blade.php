...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .nav-dropdown-toggle:hover strong { color: var(--accent); }
        .nav-dropdown-menu {
            position: absolute;
            right: 0;
            top: 100%;
            ...
            z-index: 50; /* Đảm bảo menu đè lên các nội dung bên dưới */
        }
            ...
            @auth
                <div class="nav-dropdown">
                    <span class="nav-dropdown-toggle">
                        Chào, <strong style="color: var(--text); transition: color 0.2s;">{{ auth()->user()->name }}</strong> ▾
                    </span>
                    <div class="nav-dropdown-menu">
                        <a href="{{ route('profile.index') }}">👤 Hồ sơ</a>
                        <a href="{{ route('order.history') }}">📦 Đơn hàng</a>
                        <a href="{{ route('ticket.history') }}">🎧 Hỗ trợ</a>
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('logout') }}" style="color: #ef4444;">Đăng xuất</a>
                    </div>
                </div>
            @else
