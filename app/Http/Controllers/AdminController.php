...
use App\Http\Requests\AdminStoreCarRequest;
use App\Http\Requests\AdminUpdateCarRequest;
...
class AdminController extends Controller
{
    ...
    // 4. Xử lý lưu xe mới
    public function store(AdminStoreCarRequest $request)
    {
    ...
    // 7. Xử lý cập nhật xe
    public function update(AdminUpdateCarRequest $request, $id)
    {
        $car = Car::findOrFail($id);
        $data = $request->validated();
        unset($data['image']);
